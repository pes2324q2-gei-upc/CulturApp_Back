...
afterEach(async () => {
  ...
  const collections = ['reportsUsuaris', 'reportsBugs', 'solicitudsOrganitzador', 'administradors', 'users', 'following', 'clients' , 'actividades', 'organitzadors', 'bannedUsers', 'vencidas', 'insignies']; // Agregar aquí todas las colecciones que se quieran borrar
