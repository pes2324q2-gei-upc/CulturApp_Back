...
afterEach(async () => {
  ...
  const collections = ['reportsUsuaris', 'reportsBugs', 'solicitudsOrganitzador', 'administradors', 'users', 'following', 'clients' , 'actividades', 'organizadors', 'bannedUsers']; // Agregar aquí todas las colecciones que se quieran borrar
